    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background: #ADBC9F; color:#fff;">
                <h5 class="modal-title"> Nuevo Destination </h5>
                <button type="button" class="btn-close btn-dark " data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">

                <form class="form-horizontal" id="formDestination" name="formDestination">
...
<!-- Editar informacion de los destinations-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formDestinationsEdit" name="formDestinationsEdit">
                    <p class="text-danger">Todos los campos son obligatorios</p>

                    <input type="hidden" name="iddestination" id="iddestination">
