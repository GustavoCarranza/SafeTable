...
<div class="modal fade" id="modalDestinations" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <form class="form-horizontal" id="formReserva" name="formReserva">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="txtNombre">Destination: </label>
                            <select class="form-control" name="listDestinations" id="listDestinations">
...
<!--Visualizar la informacion de la reserva-->
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formReservaEdit" name="formReservaEdit">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="txtNombre">Destination: </label>
                            <select class="form-control" name="listDestinationsEdit" id="listDestinationsEdit">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="txtFecha">Fecha de reservación: </label>
                            <input type="date" name="txtFechaEdit" id="txtFechaEdit" class="form-control" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="txtHorario">Horario de reservación: </label>
